...
public class Customer {
	...
	public Customer(int customer_id, String customer_name, String customer_phnone_num, String customer_aadhar_num,
			List<Room> rooms) {
		super();
		this.customer_id = customer_id;
		this.customer_name = customer_name;
	...
	public String toString() {
		return "Customer [customer_id=" + customer_id + ", customer_name=" + customer_name + ", customer_phnone_num="
				+ customer_phnone_num + ", customer_aadhar_num=" + customer_aadhar_num + ", rooms=" + rooms + "]";
	}
